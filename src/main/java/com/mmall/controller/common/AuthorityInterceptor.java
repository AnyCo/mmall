...
public class AuthorityInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        HandlerMethod handlerMethod = (HandlerMethod)handler; //请求中Controller中的方法名
        String methodName = handlerMethod.getMethod().getName();
        String className = handlerMethod.getBean().getClass().getSimpleName();


        StringBuffer requestParamBuffer = new StringBuffer();
        Map paramMap = request.getParameterMap(); //请求参数map
        ...
        while (it.hasNext()){
            ...
            requestParamBuffer.append(mapKey).append("=").append(mapValue); //记录请求参数
        }
        ...
        String loginToken = CookieUtil.readLoginToken(request);//从request中读取token后，去redis获取对应的user
